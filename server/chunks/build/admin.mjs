...
async function L() {
  var _a, _b, _c, _d, _e;
  const n = I(await C("getShowroomAdmin", {}));
...
function fe(n) {
  ...
  }), ssr(re, ssrHydrationKey(), escape(createComponent(For, { get each() {
    return a();
  }, get fallback() {
