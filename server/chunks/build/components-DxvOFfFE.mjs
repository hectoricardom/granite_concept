...
import { Z as Ze, v as et, D as De, w as I } from '../nitro/nitro.mjs';

function A(e) {
  e = mergeProps({ inactiveClass: "inactive", activeClass: "active" }, e);
  const [, r] = splitProps(e, ["href", "state", "class", "activeClass", "inactiveClass", "end"]), i = Ze(() => e.href), o = et(i), l = De(), a = createMemo(() => {
    const n = i();
    if (n === void 0) return [false, false];
    const t = I(n.split(/[?#]/, 1)[0]).toLowerCase(), s = decodeURI(I(l.pathname).toLowerCase());
...
export { A };
//# sourceMappingURL=components-DxvOFfFE.mjs.map
