...
import { f, w, h } from './images-mTFtFHLz.mjs';
...
function oe(t) {
  const { t: a, lang: n } = zt(), s = t.available ? w(t.escena, t.material.slug) : "", [c, b] = createSignal(s), [o, d] = createSignal(""), [$, L] = createSignal("a"), [A, w$1] = createSignal(!t.available), [S, M] = createSignal(h()), [j, f$1] = createSignal("");
  let m = 0;
  function h() {
