...
import { n as nt, d as a, k, c as t, e as r } from '../nitro/nitro.mjs';
import { w, h } from './images-B43p2foP2.mjs';
...
function ie(t) {
  const { t: r } = J(), l = h(t.escena, t.material.slug), [i, u] = createSignal(l), [v, c] = createSignal(""), [b, A] = createSignal("a"), [E, w$1] = createSignal(false), [I, _] = createSignal(m()), [x, L] = createSignal("");
  let d = 0;
  function m() {
...
const $e = k(() => t(), "materials"), ye = k(() => r(), "trabajos");
function Ce() {
  const { t } = J(), r = y(() => $e()), l = y(() => ye());
