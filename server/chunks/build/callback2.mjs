...
import { l, Y, x } from './auth-C4c1oFqj.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
function N() {
  const a = He(), [e, o] = createSignal(null);
  ...
  }), ssr(b, ssrHydrationKey(), escape(createComponent(ht, { children: "Acceso \u2014 Granite Concepts" })), escape(createComponent(Show, { get when() {
    return e();
  }, get fallback() {
...
export { N as default };
//# sourceMappingURL=callback2.mjs.map
