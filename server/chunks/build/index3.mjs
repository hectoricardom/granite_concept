...
import { c as nt, e as a, k as k$1, f as t, d as n } from '../nitro/nitro.mjs';
...
const z = k$1(() => t(), "trabajos"), H = k$1(() => n(), "materials");
function B() {
  const u = y(() => z()), $ = y(() => H()), [e] = nt(), { t: s } = J(), d = createMemo(() => {
    var _a;
