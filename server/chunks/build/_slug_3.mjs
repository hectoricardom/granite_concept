...
import { x as xt, A as At, R as Rt, L as Lt, a as A$1, u, U, s } from '../nitro/nitro.mjs';
...
function K() {
  ...
  return ssr(C, ssrHydrationKey(), ssrStyleProperty("padding-block:", "var(--sp-5)"), escape(createComponent(Show, { get when() {
    ...
    return t().desc[c()];
  } }), ssr(M, ssrHydrationKey(), ssrStyleProperty("display:", "grid") + ssrStyleProperty(";grid-template-columns:", "repeat(auto-fit, minmax(min(20rem, 100%), 1fr))") + ssrStyleProperty(";gap:", "var(--sp-4)") + ssrStyleProperty(";align-items:", "center"), ssrAttribute("src", escape(E(t().slug), true), false), `Textura macro de ${escape(t().nombre, true)}`, ssrStyleProperty("border-radius:", "var(--radius)") + ssrStyleProperty(";width:", "100%") + ssrStyleProperty(";height:", "auto"), ssrStyleProperty("text-transform:", "capitalize"), escape(t().tipo), escape(t().nombre), escape(t().desc[c()]), escape(createComponent(For, { get each() {
